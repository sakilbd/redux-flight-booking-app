    ...
    <tr class="lws-bookedTable text-black">
      ...
      <td class="px-6 py-4">
        <div class="flex items-center space-x-3">
          <p class="lws-bookedFrom">{bookInfo.destination_from}</p>
        </div>
      </td>
      <td class="px-6 py-4">
        <p class="lws-bookedTo">{bookInfo.destination_to}</p>
      </td>
      <td class="px-6 py-4 text-center">
        <p class="lws-bookedDate">{bookInfo.journey_date}</p>
      </td>
      <td class="px-6 py-4 text-center">
        <p class="lws-bookedGustes">{bookInfo.guests}</p>
      </td>
      <td class="px-6 py-4 text-center">
        <span class="lws-bookedClass">{bookInfo.class_type} </span>
      </td>
      <td class="px-6 py-4 text-center">
